...
describe('SimpleUser Management Component', () => {
  let comp: SimpleUserComponent;
  let fixture: ComponentFixture<SimpleUserComponent>;
  let service: SimpleUserService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'simple-user', component: SimpleUserComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SimpleUserComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.simpleUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
